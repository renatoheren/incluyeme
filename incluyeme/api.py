...
router.register(r'cursos', curso_views.CursoViewset)
router.register(r'clases', horario_views.ClaseViewset)
router.register(r'evaluaciones', nota_views.EvaluacionViewset)
router.register(r'notas', nota_views.NotaAlumnoViewset)
router.register(r'pagos', pago_views.PagoAlumnoViewset)